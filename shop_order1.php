...
<form action="shop_order1.php" method="get">  
  <div class="link1">
      <p>Shop</p>
  </div>
  <div id="shopinput">
        ...
        if ($s2 == 'ALL'|| ($S3 == 1)){
            foreach($row2 as $datainfo3){
                ...
                if ($s4==1){
                    ...
                    echo '<td><a href="?DeleteOID=' . $datainfo["OID"] . '" style="font-size:24px;background:white;border:none;" id="l8"><i style="color:red" class="fa fa-close"></i></a>
                    </td>';
                    }
                    else{
                      echo '<td></td>';
